...
export const authFormSchema = (type: string) => z.object({
  ...
  // sign-up, if type is sign-in all options will not be checked (sign-in page does not have these)
  state: type == 'sign-in' ? z.string().optional() : z.string().min(2).max(2),
  firstName: type == 'sign-in' ? z.string().optional(): z.string().min(1),
  lastName: type == 'sign-in' ? z.string().optional(): z.string().min(2),
  address1: type == 'sign-in' ? z.string().optional(): z.string().min(3).max(60),
